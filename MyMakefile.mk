...
uclean:
	cd E:/Projects/PKr-Service/PKr-Installer && rm -rf PKr-Service.exe PKr-Cli.exe PKr-Base.exe
ubuild:
	GOOS=windows GOARCH=amd64 go build -ldflags="-H windowsgui" -o E:/Projects/PKr-Service/PKr-Installer/PKr-Service.exe
